...
class Calculator2Tests(unittest.TestCase):
    def testCalculator2EmptyInitialisation(self):
        self.assertRaises(ValueError, Calculator2, '')
...
#        exp = '+13*a**2+551*b**3-283165'
        exp = '13*a**2+551*b**3=283165'
        c = Calculator2('13*a_2+551*b_3=283165')
...
#        exp = '+13*a**2+551*b**3-283165'
    ...
    def test_calc_abcde_53682(self):
        timer = timeit.Timer()
        c = Calculator2('-515*a_2+5151*b_3+6611*c=1324*d_2-133*e+81398')
    ...
    def test_calc_abccde(self):
        timer = timeit.Timer()
        c = Calculator2('123*a_2+432*b_3-666*c_1=398*c_3-551*d_2+61*e_3-25412')
        self.assertEqual([('a', 2), ('b', 3), ('c', 1), ('c', 3), ('d', 2), ('e', 3)], c.unknowns)
        self.assertEqual(['a', 'b', 'c', 'd', 'e'], c.raw_unknowns)
        c.Solve()
        self.assertEqual('34567', c.stringResult)
        print timer.timeit()

    def testCalcReal(self):
        c = Calculator2('4759*a_3-6771*b_1-7214*c_3=8649*d_3-' \
